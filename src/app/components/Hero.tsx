...
function Hero() {
    return (
        <div className="bg-[#fbebb5]  mx-auto  w-full">
            <Header />
            <div className="flex flex-col  md:mx-36 justify-around md:flex-row max-w-screen-2xl p-4">
                {/* Text Content */}
                <div className=" my-auto text-center md:text-left">
                    <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold mt-6">Rocket single</h1>
                    <span className="text-3xl sm:text-4xl md:text-6xl font-semibold block mb-2">seater</span>
                    <Link href="/">
                        <p className="text-2xl mt-4 underline underline-offset-8 text-black-600 ">Shop Now</p>
                    </Link>
                </div>
                {/* Image Section */}
